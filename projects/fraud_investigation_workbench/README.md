...
All original data is in [synthetic_activity.json](fixtures/synthetic_activity.json). Entity IDs are invented identifiers, and no protected traits are accepted by the input schema.
...
The author review is recorded in [engineering-review.md](engineering-review.md). Independent automated review is recorded separately by a reviewer who did not author this project.
