...
|---|---|
| Python domain, runtime, API, storage and independent regression suites | 152 passed; 2 absent-project cases skipped |
| JavaScript domain presentation, interaction state and workspace suites | 53 passed; 4 absent-project cases skipped |
| Measured Python statement + branch coverage | **98.20%** across `app`, `portfolio` and `projects` |
...
See [domain review](STAFF_REVIEW_V2.md), [platform review](STAFF_PLATFORM_REVIEW.md), [package review](PACKAGE_REVIEW.md), and [machine-readable results](VALIDATION_RESULT.json). [GitHub Actions](https://github.com/Snuthakki21/fraud-investigation-workbench/actions) runs Python 3.11/3.14, frontend/build checks and an installed-package check before Pages publication.
...
The Python source digest for the executed sample is `a7df36e28f321b36685e21b81a943a55b2b7dd15e95b45adc940943f67ae1296`. Reviewer manifests separately identify the actual files they examined. Executed reports preserve their own timestamp, input hash, source hash and model mode.
